...
public class PdfAddActivity extends AppCompatActivity {
    ...
    //tao mang de luu pdf categories
...
//init firebase auth
    ...
    private void uploadPdfToStorage() {
        ...
        Log.d(TAG, "uploadPdfToStorage: uploadting to storage... ");
        ...
        storageReference.putFile(pdfUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Log.d(TAG, "OnFailre: PDF upload failed due to" + e.getMessage());
        ...
        ref.child("" + timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        progressDialog.dismiss();
                        Log.d(TAG, "onSuccess: Success to uploaded  ");
    ...
    //selected categoryid categorytitle
    ...
    private void pdfPickIntent() {
        Log.d(TAG, "pdfPickIntent pdf pick intent");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 1000) {
            if (resultCode == -1) {
                ...
                Log.d(TAG, "onActivityResults: URI" + pdfUri);
